"""
	write(path::AbstractString, orbital::ORBITAL, ::Type{wannier90_centres}; mode = "w", comment="")
	write(io::IO, orbital::ORBITAL, ::Type{wannier90_centres}; comment="")

Write a `ORBITAL` object to file in wannier90_centres.dat format.
"""
