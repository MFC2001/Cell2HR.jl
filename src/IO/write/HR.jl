...
"""
	write(path::AbstractString, hr::HR, ::Type{wannier90_hr}; mode = "w", comment = "")
	write(io::IO, hr::HR, ::Type{wannier90_hr}; comment = "")

Write a `HR` object to file in wannier90_hr.dat format.
"""
