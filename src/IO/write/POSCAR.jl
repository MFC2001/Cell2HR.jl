"""
	write(path::AbstractString, cell::Cell, ::Type{POSCAR}; mode = "w", comment = "", format = "Cartesian")
	write(io::IO, cell::Cell, ::Type{POSCAR}; comment = "", format = "Cartesian")

Write a `Cell` object to file in VASP POSCAR format.
